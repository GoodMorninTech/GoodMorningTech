...
MISTRAL_MODEL = "mistral-small-latest"  # Update with your preferred model
    ...
    try:
        ...
        for config, emails in configs.items():
            ...
            if source_amount == 1:
                ...
                news = [
                    article for source in source_news.values() for article in source
                ]
        ...
        requests.post(CRON_JOB_WEBHOOK, json={"content": f"Error: {e}"})
        print(e)
