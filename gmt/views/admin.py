...
class UserForm(form.Form):
    ...
    extras = fields.SelectMultipleField('extras', choices=["codingchallenge", "repositories"])
    password = fields.StringField('password')
    frequency = fields.SelectField('frequency', choices=[([1,2,3,4,5,6,7], "everyday"), ([1,2,3,4,5], "weekdays"), ([6,7], "weekends")])
...
class UserView(SecureModelView):
    column_list = ('email', 'confirmed', 'time', 'extras', 'frequency', 'theme', 'timezone')
...
class ArticleForm(form.Form):
    ...
    categories = fields.SelectMultipleField('categories', choices=[("ai-news", "AI"), ("corporation-news", "Corporation"), ("crypto-news", "Crypto"), ("gadget-news", "Gadget"), ("gaming-news", "Gaming"), ("robotics-news", "Robotics"), ("science-news", "Science"), ("space-news", "Space"), ("other-news", "Other")])
    source = fields.SelectField('source', choices=[("gmt", "GMT"), ("techcrunch", "TechCrunch"), ("verge", "TheVerge"), ("bbc", "BBC"), ("cnn", "CNN"), ("guardian", "Guardian")])
    formatted_source = fields.SelectField('source', choices=[("GMT", "GMT"), ("TechCrunch", "TechCrunch"), ("TheVerge", "TheVerge"), ("BBC", "BBC"), ("CNN", "CNN"), ("Guardian", "Guardian")])
...
class ArticleView(SecureModelView):
    column_list = ('title', 'description', 'content', 'thumbnail', 'categories', 'source', 'formatted_source', 'author', 'url', 'views', 'date')
...
class WriterForm(form.Form):
    ...
    badges = fields.SelectMultipleField('badges', choices=[("dev", "Dev"), ("writer", "Writer"), ("tester", "Tester")])
    confirmed = fields.BooleanField('confirmed')
...
class WriterView(SecureModelView):
    column_list = ('about', 'accepted', 'badges', 'confirmed', 'created_at', 'email', 'github', 'name', 'password', 'patreon', 'paypal', 'public_email', 'reasoning', 'timezone', 'twitter', 'user_name', 'views', 'website')
